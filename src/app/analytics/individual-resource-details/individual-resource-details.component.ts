...
@Component({
  selector: 'app-individual-resource-details',
  templateUrl: './individual-resource-details.component.html',
  styleUrls: ['./individual-resource-details.component.scss']
})
export class IndividualResourceDetailsComponent implements OnInit, OnDestroy {
  ...
  url = `${environment.settings.tableauIndividualResourceDetailsReportUrl}`;
  ...
  private loadTableauDashboard() {
    this.placeholderDiv = document.getElementById('vizContainerIRD');
