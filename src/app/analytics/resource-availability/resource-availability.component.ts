...
export class ResourceAvailabilityComponent implements OnInit, OnDestroy {
  ...
  url = `${environment.settings.tableauAvailabilityReportUrl}`;
  ...
  private loadTableauDashboard() {
    this.placeholderDiv = document.getElementById('vizContainerRA');
