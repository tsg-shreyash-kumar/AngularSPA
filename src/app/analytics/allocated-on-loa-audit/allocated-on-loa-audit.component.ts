...
@Component({
  selector: 'app-allocated-on-loa-audit',
  templateUrl: './allocated-on-loa-audit.component.html'
})
export class AllocatedOnLoaAuditComponent implements OnInit, OnDestroy {

  // -----------------------Local Variables--------------------------------------------//
  coreServiceSub: any;
  userPreferences: UserPreferences;
  destroy$: Subject<boolean> = new Subject<boolean>();
  url = `${environment.settings.tableauAllocatedWhileOnLOAAuditReportUrl}`;
  ...
  private loadTableauDashboard() {
    this.placeholderDiv = document.getElementById('vizContainerAOLA');
