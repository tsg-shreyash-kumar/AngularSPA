...
@Component({
  selector: 'app-staffing-allocations-monthly',
  templateUrl: './staffing-allocations-monthly.component.html',
  styleUrls: ['./staffing-allocations-monthly.component.scss']
})
export class StaffingAllocationsMonthlyComponent implements OnInit, OnDestroy {
  ...
  url = `${environment.settings.tableauStaffingAllocationsMonthlyReportUrl}`;
  ...
  private loadTableauDashboard() {
    this.placeholderDiv = document.getElementById('vizContainerSRM');
