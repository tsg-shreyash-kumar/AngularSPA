...
@Component({
  selector: 'app-affiliate-time-in-practice',
  templateUrl: './affiliate-time-in-practice.component.html'
})
export class AffiliateTimeInPracticeComponent implements OnInit, OnDestroy {
   ...
   url = `${environment.settings.tableauAffiliateTimeInPracticeReportUrl}`;
   ...
   private loadTableauDashboard() {
     this.placeholderDiv = document.getElementById('vizContainerATIP');
