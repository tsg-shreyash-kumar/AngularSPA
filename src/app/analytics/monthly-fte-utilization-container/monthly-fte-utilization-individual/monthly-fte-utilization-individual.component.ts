...
@Component({
  selector: 'app-monthly-fte-utilization-individual',
  templateUrl: './monthly-fte-utilization-individual.component.html'
})
export class MonthlyFteUtilizationIndividualComponent  implements OnInit, OnDestroy {
  ...
  url = `${environment.settings.tableauFTEUtilizationIndividualReportUrl}`;
  ...
  private loadTableauDashboard() {
    this.placeholderDiv = document.getElementById('vizContainerMFUI');
