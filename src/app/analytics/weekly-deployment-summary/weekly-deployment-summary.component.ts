...
@Component({
  selector: 'app-weekly-deployment-summary',
  templateUrl: './weekly-deployment-summary.component.html',
  styleUrls: ['./weekly-deployment-summary.component.scss']
})
export class WeeklyDeploymentSummaryComponent implements OnInit, OnDestroy {
  ...
  url = `${environment.settings.tableauWeeklyDeploymentSummaryReportUrl}`;
...
// ------------------------ Helper Functions------------------------------------------//
  ...
  private loadTableauDashboard() {
    this.placeholderDiv = document.getElementById('vizContainerWDS');
