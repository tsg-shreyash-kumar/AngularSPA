...
@Component({
  selector: 'app-monthly-practice-area-staffing',
  templateUrl: './monthly-practice-area-staffing.component.html'
})
export class MonthlyPracticeAreaStaffingComponent implements OnInit,OnDestroy {
   ...
   url = `${environment.settings.tableauMonthlyPracticeAreaStaffingUrl}`;
   ...
   private loadTableauDashboard() {
     this.placeholderDiv = document.getElementById('vizContainerMPAS');
